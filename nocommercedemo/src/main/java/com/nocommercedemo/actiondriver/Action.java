package com.nocommercedemo.actiondriver;
...
import com.nocommercedemo.actioninterface.ActionInterface;
...
public class Action extends Baseclass implements ActionInterface {
	 ...
	 *                    repository)
	 * 
	 * @param value       : Value wish to select from drop down list.
	 * 
	 * @param locatorName : Meaningful name to the element (E x:Year Drop down,
	 *                    items List box etc..)
	 */
